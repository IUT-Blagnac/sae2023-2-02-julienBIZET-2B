...
| 1    | link:src/main/java/exercice/Efficacite_meilleur.java[meilleur java]| Java     | Simplicité | Meilleur
...
. Veuiller récupérer la classe ExerciceTest.java dans le répertoire analyse et le mettre au même endroit que les programmes à tester
...
. Veuiller récupérer la classe TestTemps.java dans le répertoire analyse et la mettre au même endroit que les programmes à tester
. Veiller à bien changer le nom de la classe à tester
